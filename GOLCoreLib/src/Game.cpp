...
namespace gol
{
    ...
    Game::Game(const std::filesystem::path& configPath)
        ...
        , m_UnsavedWarning("Unsaved Changes", std::bind_front(&Game::HandleWindowClose, this))
    ...
    void Game::UpdateEditors(SimulationControlResult& controlResult, const PresetSelectionResult& presetResult)
    {
