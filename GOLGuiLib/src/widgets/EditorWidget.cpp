...
namespace gol
{
    ...
    FlipHorizontalButton::FlipHorizontalButton(std::span<const ImGuiKeyChord> shortcuts)
    ...
    EditorWidget::EditorWidget(const std::unordered_map<ActionVariant, std::vector<ImGuiKeyChord>>& shortcuts)
